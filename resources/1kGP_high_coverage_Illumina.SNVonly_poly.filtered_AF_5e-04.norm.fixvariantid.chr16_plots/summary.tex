...
& \multicolumn{1}{>{\columncolor{hcol2}}c}{} \\ \hline
         1kGP\_ & 1,213,906 & 1.94 & 1.94 & 0 & -- & 0 & 0 \\ 
%
...
\setlength{\itemsep}{0pt}
        \item 1kGP\_ .. \texttt{\footnotesize /hpc/local/Rocky8/dhl\_ec/software/MonopogenLite/resources/1kGP\_high\_coverage\_Ill\\\hskip2em umina.SNVonly\_poly.filtered\_AF\_5e-04.norm.fixvariantid.chr16.vcf.gz}
